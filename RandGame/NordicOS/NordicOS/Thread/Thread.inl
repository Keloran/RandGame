...
namespace NordicArts {
    namespace NordicOS {
        ...
        template <typename F>
        Thread::Thread(F functor) : m_pImpl(NULL), m_pEntryPoint(new ThreadFunctorWithArg<F, A>(function, argument)) {}
        
        template <typename C>
        Thread::Thread(void(C::*function)(), C *object) : m_pImpl(NULL), m_pEntryPoint(new ThreadMemberFunc<C>(function, object)) {}
    };
};
